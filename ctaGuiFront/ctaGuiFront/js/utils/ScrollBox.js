...
window.ScrollBox = function () {
  ...
  function setTitle () {
    ...
    if (!is_def(com.titleData)) return

    if (!is_def(com.titleData.id)) com.titleData.id = com.mainTag + 'title'
    if (!is_def(com.titleData.h)) com.titleData.h = com.outerBox.w * 0.05
    if (!is_def(com.titleData.marg)) com.titleData.marg = com.outerBox.marg
    if (!is_def(com.titleData.size)) com.titleData.size = com.titleData.h * 0.5
    if (!is_def(com.titleData.x)) {
      com.titleData.x = com.outerBox.x + com.titleData.marg
    }
    if (!is_def(com.titleData.y)) com.titleData.y = com.outerBox.y
    if (!is_def(com.titleData.weight)) com.titleData.weight = 'bold'
  ...
  function initVerticalScroll (opt_in) {
    ...
    if (!is_def(com.scrollRecV.w)) com.scrollRecV.w = com.outerBox.w * 0.015
    if (!is_def(com.scrollRecV.h)) com.scrollRecV.h = com.outerBox.h * 0.015
    if (!is_def(com.scrollRecV.marg)) com.scrollRecV.marg = 0.6
    if (!is_def(com.scrollRecV.fontSize)) {
  ...
  function setupVerticalZoom () {
    ...
    //
    // ------------------------------------------------------------------
    com[tag_zoom + 'zoomStart'] = function () {
      com.isInZoom = true
    }

    com[tag_zoom + 'zoomDuring'] = function () {
    ...
    com[tagDrag + 'dragDuring'] = function () {
      if (!com.scrollTransV.active) return
      if (!is_def(d3.event)) return
      if (!is_def(d3.event.dy)) return
    ...
    com[tag_zoom]
      .on('start', com[tag_zoom + 'zoomStart'])
      .on('zoom', com[tag_zoom + 'zoomDuring'])
  ...
  function setupVerticalScrollBar () {
    ...
    function zoomVerticalScrollBarInit () {
      if (!com.locker.is_free(com.mainTag + 'zoomVerticalScrollBarInit')) return
    ...
    function zoomVerticalScrollBarUpdate () {
      if (!is_def(com.scrollBarRecV)) return
    ...
    function recVerticalBckClickOnce (data_in) {
      if (
        ...
        } else console.error('cant do recVerticalBckClick ...', data_in)
        return
      }
      nClickTries = 0
  ...
  function initHorizontalScroll (opt_in) {
    ...
    if (!is_def(com.scrollRecH.w)) com.scrollRecH.w = com.outerBox.w * 0.015
    if (!is_def(com.scrollRecH.h)) com.scrollRecH.h = com.outerBox.h * 0.015
    if (!is_def(com.scrollRecH.marg)) com.scrollRecH.marg = 0.6
    if (!is_def(com.scrollRecH.fontSize)) {
  ...
  function setupHorizontalScrollBar () {
    ...
    function zoomHorizontalScrollBarInit () {
      if (!com.locker.is_free(com.mainTag + 'zoomHorizontalScrollBarInit')) { return }
    ...
    function zoomHorizontalScrollBarUpdate () {
      if (!is_def(com.scrollBarRecH)) return
      if (com.isInDrag || com.inUserZoom) {
    ...
    function recHorizontalBckClickOnce (data_in) {
      if (
        ...
        } else console.error('cant do recHorizontalBckClick ...', data_in)
        return
      }
      nClickTries = 0
  ...
  function resetHorizontalScroller (opt_in) {
    ...
    if (is_def(opt_in.canScroll)) com.canScroll = opt_in.canScroll
    if (is_def(opt_in.scrollVertical)) { com.scrollHorizontal = opt_in.scrollHorizontal }
    if (is_def(opt_in.scrollWidth)) com.scrollWidth = opt_in.scrollWidth
