...
window.ScrollForm = function (opt_in) {
  ...
  if (com.quickScroll.enabled) { root_divWidth = 'calc(100% - ' + com.quickScroll.width + ')' }
    ...
    div
      ...
      .each(function (d) {
        if (Array.isArray(d)) {
          ...
          if (d.format === 'plainText') plainText_div(d3.select(this))
          else if (d.format === 'info') info_div(d3.select(this))
          else if (d.format === 'input_number') inputNumber(d3.select(this))
          else if (d.format === 'comboList') dropDown_div(d3.select(this))
          else if (d.format === 'modification') modification_div(d3.select(this))
