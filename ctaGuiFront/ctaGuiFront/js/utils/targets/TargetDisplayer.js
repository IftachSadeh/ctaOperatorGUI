    ...
    function update () {
      ...
      var node = com.linkMap.map.g.append('g')
        ...
        .each(function (d) {
          ...
          if (d.type === 'target') target_icon(g, {w: sizeTarget, h: sizeTarget}, get_target_short(d.data), {}, colorPalette)
          else if (d.type === 'pointing') pointing_icon(g, {w: sizePointing, h: sizePointing * 0.8}, get_pointing_value(d.data), {}, colorPalette)
        })
