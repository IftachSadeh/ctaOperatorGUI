...
window.PlotTimeBar = function () {
  ...
  function initAxis (opt_in) {
    if (!is_def(opt_in.showTopAxis)) opt_in.showTopAxis = true
    if (!is_def(opt_in.showBottomAxis)) opt_in.showTopAxis = true
    if (!is_def(opt_in.topAxisOrientation)) opt_in.topAxisOrientation = 'top'
    if (!is_def(opt_in.bottomAxisOrientation)) { opt_in.bottomAxisOrientation = 'bottom' }
    ...
    if (opt_in.topAxisOrientation === 'bottom') { com.top.axis.x = d3.axisBottom(com.top.scale.x) }
  ...
  function setupZoomBrush () {
    ...
    com.zoomEnd = function (ele) {
      ...
      if (com.top.domain) {
        ...
        if (is_same0 && is_same1) com.top.domain = null
      }
      updateTopAxis()
      com.isInZoom = false
      locker.remove({
