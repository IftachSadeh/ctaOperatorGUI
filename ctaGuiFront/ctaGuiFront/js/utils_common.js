...
window.TelInfo = function () {
  ...
  // telescope ids
  // ------------------------------------------------------------------
  var telIds = window.__sockTelInfo__.telIds
  this.getIds = function () {
    return deepCopy(telIds)
  }

  var telIdToTypes = window.__sockTelInfo__.telIdToTypes
  this.getIdToTypes = function () {
    return deepCopy(telIdToTypes)
  }
