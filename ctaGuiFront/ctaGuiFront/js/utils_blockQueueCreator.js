  ...
  blockQueue.saveModificationAndUpdateBlock = function (block, modif) {
    ...
    for (let i = 0; i < tot.length; i++) {
      if (tot[i].obId === block.data.obId) {
        ...
        console.log(tot[i].modifications);
      }
    }
...
//   }
//
//   function setDefaultStyle (optIn) {
...
//         if (optIn.d.data.endTime < com.data.currentTime.time) return com.blocks.colorPalette.shutdown.background
//
//         let state = hasVar(optIn.state)
//           ? optIn.state
//           : optIn.d.data.exeState.state
...
//           ? optIn.canRun
//           : optIn.d.data.exeState.canRun
//         let modified = optIn.d.data.modifications.userModifications.length > 0
//
//         if (state === 'wait') {
//           if (modified) return com.blocks.colorPalette.wait.background
//           return com.blocks.colorPalette.wait.background
//         } else if (state === 'run') {
//           return com.blocks.colorPalette.run.background
//         } else if (state === 'cancel') {
//           if (hasVar(canRun)) {
//             if (!canRun) return com.blocks.colorPalette.cancelOp.background
//           }
//           return com.blocks.colorPalette.cancelSys.background
//         } else return com.blocks.colorPalette.shutdown.background
//       }
//     }
//
//     com.style.blockCol = optIn.blockCol
//     if (!hasVar(com.style.blockCol)) {
//       com.style.blockCol = function (optIn) {
//         if (optIn.d.data.endTime < com.data.currentTime.time) return com.blocks.colorPalette.shutdown
//
//         let state = hasVar(optIn.state)
//           ? optIn.state
//           : optIn.d.data.exeState.state
...
//     }
//
//     com.style.blockOpac = optIn.blockOpac
//     if (!hasVar(com.style.blockOpac)) {
//       com.style.blockOpac = function (optIn) {
//         if (optIn.d.data.endTime < com.data.currentTime.time) return 1
//
//         let state = hasVar(optIn.state)
//           ? optIn.state
//           : optIn.d.data.exeState.state
...
//       .attr('x', -0)
//       .attr('y', -10)
//       .attr('width', com.main.box.w + 0)
//       .attr('height', com.main.box.h + 10)
//       .style('fill', com.background.attr.fill)
//       .style('stroke', com.background.attr.stroke)
//       .style('stroke-width', com.background.attr.strokeWidth)
//     // com.background.child.runOverflow.group.back.append('rect')
//     //   .attr('x', com.blocks.run.box.x)
//     //   .attr('y', com.blocks.run.box.y - com.blocks.run.box.h * 0.25 - com.blocks.run.box.marg)
//     //   .attr('width', com.blocks.run.box.w)
...
//         .text('Tels conflict')
//         .attr('x', (com.blocks.run.box.w / 30) + (com.blocks.run.box.w / 15) * i)
//         .attr('y', com.blocks.run.box.y - com.blocks.run.box.h * 0.14 - com.blocks.run.box.marg)
//         .style('font-weight', 'bold')
//         .attr('text-anchor', 'middle')
//         .style('font-size', 6)
//         .style('fill', com.background.attr.fill)
...
//       .attr('transform', 'translate(' + com.blocks.run.box.x + ',' + com.blocks.run.box.y + ')')
//     com.blocks.cancel.g = com.main.g.append('g')
//       .attr('transform', 'translate(' + com.blocks.cancel.box.x + ',' + com.blocks.cancel.box.y + ')')
//     com.blocks.modification.g = com.main.g.append('g')
//       .attr('transform', 'translate(' + com.blocks.modification.box.x + ',' + com.blocks.modification.box.y + ')')
//   }
...
//     }
//
//     com.filters.group.g = com.main.g.append('g')
...
//     com.timeBars.group.g = com.main.g.append('g')
...
//     let minTxtSize = com.main.box.h * 0.07
//
...
//
//   function saveModificationAndUpdateBlock (block, modif) {
//     let tot = []
//     for (let key in com.data.filtered) {
//       tot = tot.concat(com.data.filtered[key])
//     }
...
//     let newStart = Math.floor(timeScale.invert(com.interaction.newG.select('g rect.modified').attr('x')))
//     let modif = {prop: 'startTime', old: newBlock.data.startTime, new: newStart}
//     saveModificationAndUpdateBlock(newBlock, modif)
//     // if (isGeneratingTelsConflict(newBlock)) {
//     //   com.data.modified.conflict.push(newBlock)
//     // } else {
//     //   com.data.modified.integrated.push(newBlock)
