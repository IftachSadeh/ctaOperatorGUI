...
let mainSchedBlocksController = function (optIn) {
  ...
  function initData (dataIn) {
    ...
    svgBlocksCreator.initData(dataIn.data)
  ...
  function updateData (dataIn) {
    ...
    svgBlocksCreator.updateData(dataIn.data)
  ...
  let svgBlocksCreator = new SvgBlocksCreator()
