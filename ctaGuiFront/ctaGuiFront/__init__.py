...
def main(global_config, **settings):
  ...
  authn_policy = AuthTktAuthenticationPolicy('sosecret', callback=get_groups, hashalg='sha512')
  authz_policy = ACLAuthorizationPolicy()

  config = Configurator(settings=settings,root_factory=app_name+'.py.utils.Models.RootFactory')
