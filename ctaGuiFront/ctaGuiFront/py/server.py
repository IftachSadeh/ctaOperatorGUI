...
try:
    if input_args['site_type'] not in ['N', 'S']:
        raise Exception('must specify --site_type as "N" or "S"')
except Exception as e:
    raise e

if input_args['site_type'] == 'N':
    settings = {
        'app_name': 'ctaGuiFront', 'allow_panel_sync': '1', 'pyramid.reload_templates': 'true', 'is_simulation': '1', 'app_prefix': 'cta', 'redis_port': '6379', 'sqlalchemy.url': 'sqlite://///Users/sadeh/test/ctaOperatorGUI/ctaGuiFront/ctaGuiFront.db', 'site_type': 'N',
    }
...
try:
    ...
    log = LogParser(base_config=base_config, title=__name__, log_level='INFO', log_file='logs/ctaGuiFront_uvicorn.log',)
    ...
    async def hello_websocket(scope, receive, send):
        while True:
            ...
            if message["type"] == "websocket.connect":
                ...
                print('++++++++++++++++++++++++websocket.connect', message )
